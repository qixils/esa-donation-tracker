# Generated by Django 2.0.4 on 2018-04-18 16:48

from django.db import migrations

# Data migration to populate Country table with ISO countries.
...
def load_countries(apps, schema_editor):
    # We can't import the Country model directly as it may be a newer version than this migration expects.
    Country = apps.get_model('tracker', 'Country')

    for name, alpha2, alpha3, numeric in COUNTRIES:
        try:
            country = Country.objects.get(alpha2=alpha2)
        except Country.DoesNotExist:
            country = Country(alpha2=alpha2)
