...
def f0013_populate_prize_contributors(apps, schema_editor):
    ...
    AuthUser = Prize.provider.field.remote_field.model
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runneryoutube', models.CharField(blank=True, max_length=128, null=True, unique=True, verbose_name='Youtube Account')),
                ('runnertwitch', models.CharField(blank=True, max_length=128, null=True, unique=True, verbose_name='Twitch Account')),
                ('runnertwitter', models.CharField(blank=True, max_length=128, null=True, unique=True, verbose_name='Twitter Account')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runners', models.ManyToManyField(blank=True, null=True, to='tracker.Donor')),
            ],
            options={
