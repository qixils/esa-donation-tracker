# Generated by Django 2.0.4 on 2018-04-23 00:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tracker', '0003_add_country_records'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='donation',
            name='domain',
            field=models.CharField(choices=[('LOCAL', 'Local'), ('CHIPIN', 'ChipIn'), ('PAYPAL', 'PayPal'), ('TILTIFY', 'Tiltify')], default='LOCAL', max_length=255),
        ),
    ]
